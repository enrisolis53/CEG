...
$DB->query("SELECT transdate, proj_name, proj_date_from, proj_date_to, proj_cost, particulars, remarks, preparedby FROM tbl_proj_profile WHERE brcode=? AND transno=?");
...
echo "success~<table width='100%'><tr><td align='left'><font color='#1B510B' size=3><b>Project profile saved successfully!</b></font></td><td align='right' valign='top' rowspan=2><img src='/../../images/like1.png' width=30 height=25 /></td></tr><tr><td><font size=1>Redirecting, please wait...</font></td></tr></table>";
echo "<!DOCTYPE html>
<html>
<body>
<script>	
